...
<li onclick="get_user_list('all')" class="nav_button"><span class="glyphicon glyphicon-pencil"></span> Update Profile</li>

<li onclick="get_user_list('active')"class="nav_button"><span class="glyphicon glyphicon-lock"></span> Change Password</li>
