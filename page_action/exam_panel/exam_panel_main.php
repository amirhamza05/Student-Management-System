		...
		<div class="col-md-3">
			<div class="exam_panel_left">
				...
				<div class="panel_left_option">
					<div class="panel_option_link"><span class="glyphicon glyphicon-list-alt icon_class"></span> Exam Dashboard</div>
					<div class="panel_option_link" onclick="admit_card()"><span class="glyphicon glyphicon-flag icon_class"></span> Exam Admit Card</div>
					<div class="panel_option_link"><span class="glyphicon glyphicon-flag icon_class"></span> Exam List</div>
