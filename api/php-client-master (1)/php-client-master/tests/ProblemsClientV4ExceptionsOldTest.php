...
class ProblemsClientV4ExceptionsOldTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testAutorizationFail()
    {
        ...
        $endpoint = 'unittest';
        $invalidClient = new ProblemsClientV4(
        		$access_token,
                $endpoint,
                false);
    ...
    {
        try {
            new ProblemsClientV4('', 'abcdefg', true);
            $this->assertTrue(false);
    ...
    {
        try {
            new ProblemsClientV4('', 'abcdefgh123456789', true);
            $this->assertTrue(false);
        } catch (\RuntimeException $e) {
            $this->assertEquals(0, $e->getCode());
        }
    ...
    {
        try {
            new ProblemsClientV4('', 'compilers.sphere-engine.lo', true);
            $this->assertTrue(false);
        } catch (\RuntimeException $e) {
            $this->assertEquals(0, $e->getCode());
        }
    ...
    public function testGetJudgeFileMethodNonexistingJudge()
    {
        ...
        try {
            self::$client->getSubmissionFile($nonexistingJudge, 'source');
            $this->assertTrue(false);
        } catch (SphereEngineResponseException $e) {
            $this->assertEquals(404, $e->getCode());
        }
    ...
    {
        try {
            self::$client->getJudgeFile(1001, 'fakefile');
            $this->assertTrue(false);
        } catch (SphereEngineResponseException $e) {
            $this->assertEquals(404, $e->getCode());
        }
    ...
    public function testGetSubmissionFileMethodNonexistingSubmission()
    {
        $nonexistingSubmission = 9999999999;
        try {
            self::$client->getSubmissionFile($nonexistingSubmission, 'source');
            $this->assertTrue(false);
        } catch (SphereEngineResponseException $e) {
            $this->assertEquals(404, $e->getCode());
        }
    ...
    {
        try {
            self::$client->getSubmissionFile(1, 'fakefile');
            $this->assertTrue(false);
        } catch (SphereEngineResponseException $e) {
            $this->assertEquals(404, $e->getCode());
        }
    ...
    {
        try {
            self::$client->createSubmissionMultiFiles('TEST', [], 1);
            $this->assertTrue(false);
        } catch (SphereEngineResponseException $e) {
            $this->assertEquals(400, $e->getCode());
        }
    ...
    {
        try {
            self::$client->createSubmissionMultiFiles('NON_EXISTING_CODE', ['file1' => 'a'], 1);
            $this->assertTrue(false);
        } catch (SphereEngineResponseException $e) {
            $this->assertEquals(404, $e->getCode());
        }
    ...
    {
        try {
            self::$client->createSubmissionWithTarSource('TEST', '', 1);
            $this->assertTrue(false);
        } catch (SphereEngineResponseException $e) {
            $this->assertEquals(400, $e->getCode());
        }
    ...
    {
        try {
            self::$client->createSubmissionWithTarSource('NON_EXISTING_CODE', 'nonempty_source', 1);
            $this->assertTrue(false);
        } catch (SphereEngineResponseException $e) {
            $this->assertEquals(404, $e->getCode());
        }
